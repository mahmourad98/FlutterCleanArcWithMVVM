...
import 'package:untitled05/extras/constants/app_theme.dart';
    ...
    if(Platform.isAndroid) {
      return MaterialApp(
        ...
        builder: (BuildContext buildContext, Widget? childWidget,) {
          ...
          return Theme(
            data: AppTheme.isDarkTheme ? AppTheme.appThemeDark : AppTheme.appThemeLight,
            child: childWidget,
          );
        },
      ...
      return CupertinoApp(
        ...
        useInheritedMediaQuery: true,
        title: AppConfig.appName,
        theme: CupertinoThemeData(textTheme: CupertinoTextThemeData(textStyle: TextStyle(fontFamily: _fontFamily,),),),
        builder: (BuildContext buildContext, Widget? childWidget,) {
          _setDeviceOrientation();
          childWidget = BotToastInit().call(buildContext, childWidget,);
          childWidget = AppLifeCycleWrapper(childWidget, const [],);
      ...
      return const SizedBox.expand(child: Text("Platform is not supported",),);
    }
  }
  /////////////////////////
  void _setDeviceOrientation() => SystemChrome.setPreferredOrientations([DeviceOrientation.portraitUp,],);
  /////////////////////////
